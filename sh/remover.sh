...
echo -e "\033[1;31m[\033[1;36m3\033[1;31m]\033[1;33m BACK"
echo ""
...
if [[ -z $option ]]; then
	...
	if cat /etc/passwd |grep -w $user > /dev/null; then
		...
		tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "O usuário $user does not exist!" ; echo "" ; tput sgr0
	fi
fi
elif [[ "$resp" = "2" ]]; then
	clear
	tput setaf 7 ; tput setab 4 ; tput bold ; printf '%32s%s%-13s\n' "Remove SSH User" ; tput sgr0
	echo ""
	echo -ne "\033[1;33mREALLY WANT TO REMOVE ALL USERS \033[1;37m[s/n]: "; read opc	
	if [[ "$opc" = "s" ]]; then
	echo -e "\n\033[1;33mWaiting\033[1;32m.\033[1;31m.\033[1;33m.\033[0m"
        ...
        rm *.zip > /dev/null 2>&1
		echo -e "\n\033[1;32mSUCCESSFUL REMOVED USERS!\033[0m"
		sleep 2
		menu
	else
