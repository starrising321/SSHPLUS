...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@StoPhVPS & @Amirnet71\n"
  echo -ne " \033[1;31m ENTER \033[1;33mto return to \033[1;32mMENU!\033[0m"; read
  menu
} || {
  echo -e "  \033[1;36mTHERE IS A NEW UPDATE AVAILABLE!\033[1;33m\n"
  echo -e "  \033[1;33mMORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@StoPhVPS & @Amirnet71\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    sleep 3
    wget ssh-plus.tk/script/ > /dev/null 2>&1
    chmod +x Plus
    ./Plus
    clear
