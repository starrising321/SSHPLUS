...
mine_port ; echo -e "====================" ; echo -e "\033[1;36mSupport:" ; echo -e "\033[1;95m➩ Online Games" ; echo -e "\033[1;91m➩ ʏᴏᴜᴛᴜʙᴇ ʜᴅ" ; echo -e "\033[1;92m➩ Whatsapp Video call " ; echo "" ; echo -e "\E[44;1;44mᵇʸ @StarZany ☆ @star_Jani\E[0m" ; echo "" || echo "Unable to create user!" ; tput sgr0
                                sleep 1
                                function aguarde {
                                  helice () {
