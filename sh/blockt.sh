...
echo -e "\E[44;1;37m           FIREWALL TORRENT LOCK           \E[0m"
echo ""
if [[ -e "$arq" ]]; then
	fun_fireoff () {
...
if [[ "$resp" = 's' ]]; then
	...
	echo ""
	echo -e "\033[1;32mFIREWALL REMOVED SUCCESSFULLY !"
	echo ""
	if [[ -e /etc/openvpn/openvpn-status.log ]]; then
		echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m RESTART SYSTEM TO FINISH"
		echo ""
		read -p "$(echo -e "\033[1;32mRESTART NOW \033[1;31m? \033[1;33m[s/n]:\033[1;37m ")" -e -i s respost
		echo ""
		if [[ "$respost" = 's' ]]; then
			echo -ne "\033[1;31mRestarting VPS" 
...
echo ""
echo -e "\033[1;32mSUCCESSFULLY APPLIED !"
sleep 3
menu
else
	sleep 1
